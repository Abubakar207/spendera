...
<body>
    ...
    <div class="budget-container mt-5">
        ...
        <div class="new-transaction-dashboard">
            ...
            <div class="dash-title">Add Income</div>
                ...
                <div id="income">
                    ...
                    <div class="input">
                        ...
                        <select name="category" id="income-category-input" onchange="AddCategory(this.value)" required>
                            ...
                            <?php
                            $query = "select * from category_tb where CategoryType = 'Income' ";
                  ...
                  <option value="AddNewCategory">  Add New Category  </option>
                        ...
                        <label for="repeating-transaction">Repeating Transaction</label>
                        <input type="checkbox" name="rtransaction" id="repeating-transaction">
                    </div>
                </div>
            ...
            <div class="income-button-select">
                ...
                <input type="submit" class=" btn btn-dark  m-2" value="Add" id="add" name='SubmitIncomeForm'>
                </div>
            </div>
        </div>
        </form>

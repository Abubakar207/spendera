            ...
            <div class="table-responsive">
                ...
                <input type="text" name="key" id="key" placeholder="Search" class="form-control mx-2" style="width: 80%;">
                    ...
                    <tbody>
                        ...
                        ?>
                            <td>
                            <a href="Category.php?DelIdCategory=<?php echo $id ?>" style="color:black;"> <i class="fa-solid fa-trash-can"> </i> </a>
                            </td>
                        ...
                        ?>
                        <tr>
                            <td colspan="5"> <a href="AddCategory.php" class="btn btn-dark  btn-lg">Add Category</a></td>
                        </tr>

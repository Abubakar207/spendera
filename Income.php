            ...
            <div class="table-responsive">
                ...
                <input type="text" name="key" id="key" placeholder="Search" class="form-control mx-2" style="width: 80%;">
                    ...
                    <tbody>
                        <?php
                        $id = $_SESSION['id'];
                        $query = "select * from transaction_tb where UserId = $id and `TransactionType` = 'Income' ";
                        ...
                        ?>
                            ...
                            <a href="Income.php?DelId=<?php echo $id ?>" style="color:black;"> <i class="fa-solid fa-trash-can"> </i> </a>
                            </td>
                        ...
                        ?>
                        <tr>
                            <td colspan="5"> <a href="AddTransaction.php" class="btn btn-dark  btn-lg">Add Income</a></td>
                        </tr>
